...
Com esses resultados, devemos **rejeitar a hipótese de normalidade da amostra**.
...
Na análise da atividade *1.3*, os resultados obtidos **rejeitaram** a hipótese de normalidade para ambas as variáveis (Nota em Matemática e Nota em Língua Portuguesa) para a amostra n=2000. Como nesta atividade (*3.2*) estou trabalhando com duas subamostras (n=20 e n=200) retiradas dessa amostra n=2000 (da atividade *1.3*), era de se esperar que, assim como a análise anterior, por mais que a abordagem visual com o histograma e com o gráfico *Q-Q* se assemelhem ao esperado de uma distribuição normal, os testes de normalidade e aderência comprovam que esta é uma falsa premissa nos casos aqui estudados.